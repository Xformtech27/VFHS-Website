...
<html lang="en">
  ...
  <body>
    ...
    <div class="page-wrapper">
        ...
        <div class="hero-slider">
          <div class="slide">
            ...
            <div class="container">
              <div class="row">
                <div
                  class="col col-lg-6 col-lg-offset-3 col-sm-10 col-sm-offset-1 slide-caption"
                >
      ...
      <section class="projects-section-s2 section-padding padding-bottom-0">
            ...
            <div class="col col-lg-8 col-md-8">
              <div class="title-text">
                <p>
                  ...
                  laboris nisi ut aliquip ex ea commodo ex ea commodo consequat.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col col-xs-12">
              <div class="pricing-content">
                ...
                <div class="tablinks">
                  <ul>
                    <li class="active">
                      <a href="#tab-b1" data-toggle="tab">Steel</a>
                    </li>
                    <li>
                      <a href="#tab-b2" data-toggle="tab">Construction</a>
                    </li>
                    <li>
                      <a href="#tab-b3" data-toggle="tab">Knitwear</a>
                    </li>
                    <li>
                      <a href="#tab-b4" data-toggle="tab">Bridge</a>
                    </li>
                    <li>
                      <a href="#tab-b5" data-toggle="tab">Timber</a>
                    </li>
                    <li>
                      <a href="#tab-b6" data-toggle="tab">Others</a>
                    </li>
                  </ul>
                </div>
                      ...
                      <div class="grid">
                        ...
                        <div class="pricing-body">
                          <ul>
                            ...
                            <li>Ut enim ad minim veniam quis nostru</li>
      ...
      <!-- start news-section-s3 -->
      <section class="news-section-s3 section-padding">
        <div class="container">
          <div class="row">
            <div class="col col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1">
              <div class="section-title">
