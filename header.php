        ...
        <div class="row">
          <div class="col col-sm-6">
            <div class="office-hour">
              <ul>
                <li>
                  <i class="fa fa-clock-o"></i> Monday - friday : 8:00 AM to
                  7:00 PM
                </li>
              </ul>
            </div>
          ...
          <div class="col col-sm-6">
            <div class="contact-info">
              <ul>
                ...
                <li>
                  <i class="fa fa-envelope"></i> info-desk@clinkers.com
                </li>
              </ul>
            </div>
          </div>
    ...
    <nav class="navigation navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/vintage-flow-hdyro-system/index-2.php"><img src="/vintage-flow-hdyro-system/assets/images/logo.png" alt /></a>
        </div>
        <div
          id="navbar"
          ...
          <ul class="nav navbar-nav">
            <li class="menu-item-has-children">
              <a href="/vintage-flow-hdyro-system/index-2.php" class="<?php if ($page == 'home') {
                                                                        echo 'active';
                                                                      } ?>">Home</a>
            </li>
            <li><a href="/vintage-flow-hdyro-system/about.php" class="<?php if ($page == 'about') {
                                                                        echo 'active';
                                                                      } ?>">About</a></li>

            <li class="menu-item-has-children">
              <a href="#" class="<?php if ($page == 'product') {
                                    echo 'active';
                                  } ?>">Product</a>
              <ul class="sub-menu">
            ...
            <li class="menu-item-has-children">
              <a href="/vintage-flow-hdyro-system/services.php" class="<?php if ($page == 'services') {
                                                                          echo 'active';
                                                                        } ?>">Services</a>
            </li>
            <li class="menu-item-has-children">
              <a href="#" class="<?php if ($page == 'pages') {
                                    echo 'active';
                                  } ?>">Pages</a>
              <ul class="sub-menu">
            ...
            <li><a href="/vintage-flow-hdyro-system/contact.php" class="<?php if ($page == 'contact') {
                                                                          echo 'active';
                                                                        } ?>">Contact</a></li>
