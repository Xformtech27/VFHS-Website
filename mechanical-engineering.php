                        ...
                        <div class="service-single-sidebar">
                            <div class="services-link-widget widget">
                                <ul>
                                    ...
                                    <li><a href="meterial-engineering.php">Meterial engineering</a></li>
                                    <li class="current"><a href="mechanical-engineering.php">Mechanical engineering</a></li>
                                    <li><a href="chemical-research.php">Chemical research</a></li>
                                    <li><a href="alternate-energy.php">Alternate energy</a></li>
                                    <li><a href="agricultural-processing.php">Agricultural processing</a></li>
                                </ul>
                            </div>
